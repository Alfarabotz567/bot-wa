...
var { state, saveState } = useSingleFileAuthState(`./session.json`);
}
...
async function start(){
  ...
  console.log(color(figlet.textSync('WhatsApp - Bot', {font: 'Standard',horizontalLayout: 'default',vertivalLayout: 'default',width: 80,whitespaceBreak: false }), 'red'))
  console.log(color('------------------------------------------------------------------------', 'white'))
