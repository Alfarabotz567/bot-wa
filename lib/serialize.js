/**
  * List Const
  * downloadMedia(message, pathFile)
  * serialize(msg, conn)
  * conn.getFile(PATH, returnAsFilename)
  * conn.getName(jid, withoutContact = false)
  * conn.getBuffer(url, options)
  * conn.sendContact(jid, contact, quoted = false, opts = {})
  * conn.sendSticker(jid, url, quoted, option = {})
  * conn.copyNForward(jid, message, forceForward = false, options = {})
  * conn.sendGroupV4Invite(jid, participant, inviteCode, inviteExpiration, groupName = "unknown subject", jpegThumbnail, caption = "Invitation to join my WhatsApp group", options = {})
  * conn.sendImage(jid, url, quoted, option = {})
  * conn.sendVideo(jid, url, quoted, option = {})
  * conn.sendAudio(jid, url, quoted, ptt = false, option = {})
  * conn.sendFile(jid, path, filename = "", caption = "", quoted, ptt = false, options = {})
*/
